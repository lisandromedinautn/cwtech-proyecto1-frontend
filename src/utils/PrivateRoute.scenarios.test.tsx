...
describe('PrivateRoute - escenarios de autorización', () => {
  ...
  it.each([
    ...
    ['sin permiso', buildToken([99]), 'Panel de administración'],
    ['con permiso', buildToken([2]), 'Contenido privado'],
  ])('cuando el usuario está %s', (_, rawToken, expectedText) => {
    if (rawToken) {
